/*
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    HOMES Illumina shotgun metagenomics branch
    Short-read QC, taxonomy, abundance, and report outputs
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*/
...
workflow HOMES_METAGENOMICS_ILLUMINA {
    ...
    VALIDATE_METAGENOMICS_SAMPLESHEET(ch_samplesheet, 'illumina')
