include { HMMER_HMMSEARCH } from '../../../modules/homes/hmmer/hmmsearch/main'
include { HMMER_HMMRANK   } from '../../../modules/homes/hmmer/hmmrank/main'
include { SEQTK_SUBSEQ    } from '../../../modules/homes/seqtk/subseq/main'
