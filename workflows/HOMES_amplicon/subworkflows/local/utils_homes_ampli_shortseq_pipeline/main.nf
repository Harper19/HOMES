//
// Subworkflow with functionality specific to the HOMES_amplicon pipeline
//
...
include { UTILS_NFSCHEMA_PLUGIN     } from '../../homes/utils_nfschema_plugin'
include { paramsSummaryMap          } from 'plugin/nf-schema'
include { samplesheetToList         } from 'plugin/nf-schema'
include { paramsHelp                } from 'plugin/nf-schema'
include { completionEmail           } from '../../homes/utils_homes_pipeline'
include { completionSummary         } from '../../homes/utils_homes_pipeline'
include { UTILS_HOMES_PIPELINE     } from '../../homes/utils_homes_pipeline'
include { UTILS_NEXTFLOW_PIPELINE   } from '../../homes/utils_nextflow_pipeline'
...
* Software dependencies
    https://github.com/Harper19/HOMES/tree/main/workflows/HOMES_amplicon/CITATIONS.md
"""
    if (monochrome_logs) {
...
workflow PIPELINE_COMPLETION {
    ...
    workflow.onError {
        log.error "Pipeline failed. Check the Nextflow log and the output pipeline_info directory for details."
    }
}
...
def toolCitationText() {
    // HOMES: Optionally add in-text citation tools to this list.
...
def toolBibliographyText() {
    // HOMES: Optionally add bibliographic entries to this list.
...
def methodsDescriptionText(mqc_methods_yaml) {
    ...
    // HOMES: Only uncomment below if logic in toolCitationText/toolBibliographyText has been filled!
