...
# sbdiexport.R
#
# A script that collates data from HOMES_amplicon to produce four tsv files as close
...
for( c in DNA_COLS ) {
    if ( c %in% colnames(meta) ) {
        ...
        dna[[c]] <- rep('https://github.com/Harper19/HOMES/tree/main/workflows/HOMES_amplicon',n_samples)
    } else {
