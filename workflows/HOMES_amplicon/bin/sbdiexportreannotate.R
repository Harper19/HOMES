...
#
# A script that collates taxonomy data from HOMES_amplicon to produce an updated
...
taxtable  <- taxonomy %>%
    ...
    mutate(
        ...
        annotation_algorithm = case_when(
            (taxmethod == 'sintax')                         ~ paste('HOMES_amplicon ',wfversion,' (https://github.com/Harper19/HOMES/tree/main/workflows/HOMES_amplicon) VSEARCH:sintax',cut_its, sep=' '),
            (!(is.na(otu) | otu == ''))                     ~ paste('HOMES_amplicon ',wfversion,' (https://github.com/Harper19/HOMES/tree/main/workflows/HOMES_amplicon) addsh',cut_its, sep=' '),
            (!(is.na(species_exact) | species_exact == '')) ~ paste('HOMES_amplicon ',wfversion,' (https://github.com/Harper19/HOMES/tree/main/workflows/HOMES_amplicon) DADA2:assignTaxonomy:addSpecies',cut_its, sep=' '),
            TRUE                                            ~ paste('HOMES_amplicon ',wfversion,' (https://github.com/Harper19/HOMES/tree/main/workflows/HOMES_amplicon) DADA2:assignTaxonomy',cut_its, sep='')
        ),
